...
✨ **New:** This project now supports the [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) server, which allows your MCP clients (e.g. Claude Desktop) to run code generated by LLMs in a secure sandbox environment.
