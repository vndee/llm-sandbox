...
class TestSandboxKubernetesSessionInit:
    ...
    def test_default_pod_manifest_generation(
        ...
        """
        Tests that the default pod manifest generated by SandboxKubernetesSession includes the correct API version, kind, namespace, container image, and environment variables.
        """
        mock_handler = MagicMock()
        mock_create_handler.return_value = mock_handler
